...
public class RouteImpl {
    ...
    public static void launchLoginActivity() {
        RouteImpl.getInstance().create().launchLoginActivity();
    }
    ...
    public static ILoginProvider getILoginProviderImpl(String para1, int para2) {
        return RouteImpl.getInstance().create().getILoginProviderImpl(para1, para2);
    }
